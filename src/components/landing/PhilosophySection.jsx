        ...
        <motion.div
          ...
          <div>
            ...
            <motion.h2
              ...
              className="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-[1.1] mb-8">

              From Data to{' '}
              <span className="bg-gradient-to-r text-transparent py-3 from-cyan-400 via-blue-500 to-purple-600 inline-block">Understanding
